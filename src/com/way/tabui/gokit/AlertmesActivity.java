...
import com.way.tabui.gokit.AllMessageActivity.MyReceiver;
import com.way.util.Alertinfo;
import com.way.util.GizMetaData;

public class AlertmesActivity extends Activity {
...
//		 AlertmesActivity.this.unregisterReceiver(receiver);
	...
	private void initdata(){
		...
		Cursor c = db.query(true, GizMetaData.AlertTable.TABLE_NAME, columns, whereClause, whereArgs, null, null,null, null);
		if (c.getCount()==0){
			//initSQLdata();
	...
	private void initevent(){
		alert_info_listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(AlertmesActivity.this).setTitle(R.string.prompt).setMessage("确定要删除此记录吗")
    ...
    public boolean onOptionsItemSelected(MenuItem menu) {
    	// TODO Auto-generated method stub
    	 ...
    	 case android.R.id.home:
    		 ...
    		 break;
    	 case R.id.del_all:
    		 new AlertDialog.Builder(AlertmesActivity.this).setTitle(R.string.prompt).setMessage("确定要删除全部记录吗")
				.setPositiveButton(R.string.besure, new DialogInterface.OnClickListener() {
